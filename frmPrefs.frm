...
Begin VB.Form panzerPrefs 
   ...
   Begin VB.Frame fraGeneral 
      ...
      Begin VB.Frame fraGeneralInner 
         ...
         Begin VB.ComboBox cmbCurrentDrive 
            Height          =   315
            ItemData        =   "frmPrefs.frx":116D
            Left            =   2010
            List            =   "frmPrefs.frx":116F
            Style           =   2  'Dropdown List
            TabIndex        =   161
            Top             =   1920
            Width           =   1095
         ...
         Begin VB.ComboBox cmbTickSwitchPref 
            Height          =   315
            ItemData        =   "frmPrefs.frx":1171
            Left            =   2010
            List            =   "frmPrefs.frx":1173
            Style           =   2  'Dropdown List
            TabIndex        =   145
            Top             =   975
            Width           =   3720
   ...
   Begin VB.Menu prefsMnuPopmenu 
      ...
      Begin VB.Menu mnuAbout 
         Caption         =   "About Panzer Storage Widget"
      End
      Begin VB.Menu blank 
         Caption         =   "-"
      End
...
Private Sub cmbCurrentDrive_Click()
    ...
    overlayWidget.thisDrive = PzGCurrentDrive

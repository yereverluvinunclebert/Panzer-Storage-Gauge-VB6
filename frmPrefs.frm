...
Begin VB.Form widgetPrefs 
   Caption         =   "Panzer Storage Gauge Preferences"
   ClientHeight    =   10545
   ClientLeft      =   60
   ClientTop       =   510
   ClientWidth     =   8880
   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":95E2
            Left            =   1530
            List            =   "frmPrefs.frx":95E4
            Style           =   2  'Dropdown List
            TabIndex        =   46
...
Private pCmbCurrentDriveBalloonTooltip As String
...
' ----------------------------------------------------------------
' Procedure Name: cmbCurrentDrive_Click
' Purpose:
' Procedure Kind: Sub
...
' Date: 13/01/2024
' ----------------------------------------------------------------
Private Sub cmbCurrentDrive_Click()
...
cmbCurrentDrive_Click_Error:

    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure cmbCurrentDrive_Click, line " & Erl & "."
...
Private Sub optGaugeTooltips_Click(Index As Integer)
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzStorageGauge", "gaugeTooltips", gblGaugeTooltips, gblSettingsFile
...
Private Sub optPrefsTooltips_Click(Index As Integer)
   ...
   On Error GoTo optPrefsTooltips_Click_Error
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzStorageGauge", "prefsTooltips", gblPrefsTooltips, gblSettingsFile
   ...
   On Error GoTo cmbMultiMonitorResize_Click_Error
    ...
    If cmbMultiMonitorResize.ListIndex = 2 Then
        If prefsMonitorStruct.IsPrimary = True Then
            ...
            sPutINISetting "Software\PzStorageGauge", "gaugePrimaryHeightRatio", gblGaugePrimaryHeightRatio, gblSettingsFile
            
            'gblPrefsPrimaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\PzStorageGauge", "prefsPrimaryHeightTwips", gblPrefsPrimaryHeightTwips, gblSettingsFile
        Else
            gblGaugeSecondaryHeightRatio = fGauge.gaugeForm.WidgetRoot.Zoom
            sPutINISetting "Software\PzStorageGauge", "gaugeSecondaryHeightRatio", gblGaugeSecondaryHeightRatio, gblSettingsFile
            
            'gblPrefsSecondaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\PzStorageGauge", "prefsSecondaryHeightTwips", gblPrefsSecondaryHeightTwips, gblSettingsFile
        End If
    End If
...
Private Sub Form_Load()
    ...
    Me.mnuAbout.Caption = "About Panzer Storage Gauge Cairo " & gblCodingEnvironment & " widget"
...
Private Sub initialisePrefsVars()
   ...
   On Error GoTo initialisePrefsVars_Error
    ...
    pCmbCurrentDriveBalloonTooltip = vbNullString
...
Private Sub subClassControls()
   ...
   On Error GoTo subClassControls_Error
    ...
    Else
        ...
        Call SubclassComboBox(cmbCurrentDrive.hWnd, ObjPtr(cmbCurrentDrive))
...
Public Sub MouseMoveOnComboText(sComboName As String)
    ...
    Select Case sComboName
        ...
        Case "cmbDebug"
         ...
         Case "cmbCurrentDrive"
            sTitle = "Help on Drive Selection"
            sText = pCmbCurrentDriveBalloonTooltip
            If gblPrefsTooltips = "0" Then CreateToolTip cmbCurrentDrive.hWnd, sText, , sTitle, , , , True
...
Public Sub positionPrefsMonitor()
    ...
    If gblMonitorCount > 1 And LTrim$(gblMultiMonitorResize) = "2" Then
        ...
        If prefsMonitorStruct.IsPrimary = True Then
            gblPrefsFormResizedInCode = True
            gblPrefsPrimaryHeightTwips = fGetINISetting("Software\PzStorageGauge", "prefsPrimaryHeightTwips", gblSettingsFile)
            ...
            End If
        Else
            gblPrefsSecondaryHeightTwips = fGetINISetting("Software\PzStorageGauge", "prefsSecondaryHeightTwips", gblSettingsFile)
            gblPrefsFormResizedInCode = True
...
Private Sub cmbDebug_Click()
    ...
    If cmbDebug.ListIndex = 0 Then
        txtDefaultEditor.Text = "eg. E:\vb6\Panzer-Storage-Gauge-VB6MkII\Panzer-Storage-Gauge-VB6.vbp"
...
'    End If
    ...
    If gblStartup = "1" Then
        Call writeRegistry(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PanzerStorageGauge", """" & App.Path & "\" & "Panzer-Storage-Gauge-VB6.exe""")
    Else
        Call writeRegistry(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PanzerStorageGauge", vbNullString)
    End If
    ...
    If fFExists(gblSettingsFile) Then
        ...
        sPutINISetting "Software\PzStorageGauge", "showHelp", gblShowHelp, gblSettingsFile
        ...
        sPutINISetting "Software\PzStorageGauge", "widgetFunctions", gblGaugeFunctions, gblSettingsFile
        ...
        sPutINISetting "Software\PzStorageGauge", "gaugeFont", gblGaugeFont, gblSettingsFile
        ...
        sPutINISetting "Software\PzStorageGauge", "displayScreenFont", gblDisplayScreenFont, gblSettingsFile
        sPutINISetting "Software\PzStorageGauge", "displayScreenFontSize", gblDisplayScreenFontSize, gblSettingsFile
        sPutINISetting "Software\PzStorageGauge", "displayScreenFontItalics", gblDisplayScreenFontItalics, gblSettingsFile
        sPutINISetting "Software\PzStorageGauge", "displayScreenFontColour", gblDisplayScreenFontColour, gblSettingsFile
        ...
        sPutINISetting "Software\PzStorageGauge", "multiMonitorResize", gblMultiMonitorResize, gblSettingsFile
...
'        sPutINISetting "Software\PzStorageGauge", "enableTicks", gblEnableTicks, gblSettingsFile
'        sPutINISetting "Software\PzStorageGauge", "enableChimes", gblEnableChimes, gblSettingsFile
'        sPutINISetting "Software\PzStorageGauge", "enableAlarms", gblEnableAlarms, gblSettingsFile
'        sPutINISetting "Software\PzStorageGauge", "volumeBoost", gblVolumeBoost, gblSettingsFile
        ...
        sPutINISetting "Software\PzStorageGauge", "defaultVB6Editor", gblDefaultVB6Editor, gblSettingsFile
        sPutINISetting "Software\PzStorageGauge", "defaultTBEditor", gblDefaultTBEditor, gblSettingsFile
        
        sPutINISetting "Software\PzStorageGauge", "gaugeHighDpiXPos", gblGaugeHighDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzStorageGauge", "gaugeHighDpiYPos", gblGaugeHighDpiYPos, gblSettingsFile
        
        sPutINISetting "Software\PzStorageGauge", "gaugeLowDpiXPos", gblGaugeLowDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzStorageGauge", "gaugeLowDpiYPos", gblGaugeLowDpiYPos, gblSettingsFile
...
'    chkVolumeBoost.Value = Val(gblVolumeBoost)
    ...
    lblGitHub.Caption = "You can find the code for the Panzer Storage Gauge on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/Panzer-Storage-Gauge"
...
'    End With
    ...
    For I = 0 To gblDriveCount
        If gblDriveArray(I) = "" Then Exit For
        cmbCurrentDrive.AddItem gblDriveArray(I), I
        cmbCurrentDrive.ItemData(I) = I
    Next I
...
Public Sub setPrefsTooltips()
   ...
   On Error GoTo setPrefsTooltips_Error
    ...
    If optPrefsTooltips(0).Value = True Then
        ...
        pCmbCurrentDriveBalloonTooltip = "Select the drive to monitor here or by using the middle button on the gauge surround. The change will take place immediately."
...
'        chkVolumeBoost.ToolTipText = "Sets the volume of the various sound elements, you can boost from quiet to loud."
        ...
        cmbCurrentDrive.ToolTipText = "Select the drive to monitor here or by using the middle button on the gauge surround. The change will take place immediately."
    Else
...
'        chkEnableAlarms.ToolTipText = vbNullString
        ...
        cmbCurrentDrive.ToolTipText = vbNullString
    End If
